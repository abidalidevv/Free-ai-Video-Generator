...
const ENCODERS = [
  { id: "auto",     name: "Auto Detect",         sub: "Server default (FFmpeg)",status: "smart",     tone: "primary" },
  { id: "libx264",  name: "libx264 (CPU)",       sub: "Software encoder",       status: "available", tone: "default" },
  { id: "nvenc",    name: "NVIDIA NVENC",        sub: "GPU encoder (if supported)", status: "ready", tone: "success" },
  { id: "qsv",      name: "Intel Quick Sync",    sub: "Hardware encoder (if supported)", status: "available", tone: "default" },
  { id: "amf",      name: "AMD AMF",             sub: "Hardware encoder (if supported)", status: "available", tone: "default" },
];
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <PrimaryButton onClick={() => toast.success("Video settings saved successfully")}><Save className="w-4 h-4" /> Save settings</PrimaryButton>
          </>
        }
      />
        ...
        <div className="col-span-12 xl:col-span-8 space-y-6">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2.5">
              <GhostButton onClick={() => toast.success("Video settings saved as draft")}><Save className="w-4 h-4" /> Save as draft</GhostButton>
              <PrimaryButton onClick={() => navigate({ to: "/audio-studio" })}>Continue <ArrowRight className="w-4 h-4" /></PrimaryButton>
            </div>
          </div>
        </div>
